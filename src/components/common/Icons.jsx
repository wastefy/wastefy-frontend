  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      ...
      <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33
        ...
        a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68
...
export function IconChevronRight({ size = 16, color = '#AAAAAA' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPencil({ size = 18, color = '#6B6B6B' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconCheck({ size = 32, color = '#ffffff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
...
export function IconCamera({ size = 24, color = '#9A9A8A' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPlus({ size = 24, color = '#ffffff' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
...
export function IconBasket({ size = 18, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconEmail() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <rect width="18" height="18" rx="4" fill="#5B8A47" />
      <path d="M3 6l6 4.5L15 6" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
      <rect x="3" y="5.5" width="12" height="8" rx="1.5" stroke="white" strokeWidth="1.5" fill="none" />
    </svg>
  )
}

export function IconWasteLogo() {
  return (
    <svg width="50" height="50" viewBox="0 0 50 50" fill="none">
      <path d="M7 20h36l-3.5 18H10.5L7 20z" fill="rgba(200,213,190,0.25)" />
      <path d="M5 20h40" stroke="rgba(200,213,190,0.7)" strokeWidth="2" strokeLinecap="round" />
      <path d="M19 17c0-4 3-6 6-5.5" stroke="#7AB365" strokeWidth="2" strokeLinecap="round" />
      <circle cx="25" cy="15" r="3.5" fill="#7AB365" />
      <path d="M28 14c1.5-3 5-3.5 5.5-1.5" stroke="#7AB365" strokeWidth="2" strokeLinecap="round" />
      <circle cx="20" cy="15" r="2" fill="#8EC87A" />
    </svg>
  )
}
